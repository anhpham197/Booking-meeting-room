        ...
        <header class=" py-3 sticky top-0 z-10">
            <div class="px-16 mx-auto md:flex justify-between items-center">
                ...
                <nav class="space-x-4 text-sm sm:text-base text-center">
                    <a class="hover:font-bold hover:no-underline hover:text-gray-300 uppercase text-gray-300" href="{{ route('show_booking') }}">Book now</a>

                    @guest
                        <a class="hover:font-bold hover:no-underline hover:text-gray-300 uppercase text-gray-300" href="{{ route('login') }}">Login</a>
                        @if (Route::has('register'))
                            <a class="hover:font-bold hover:no-underline hover:text-gray-300 uppercase text-gray-300" href="{{ route('register') }}">Register</a>
                        @endif
                    @else
